...
- Emits or attaches [AI Session evidence](./agentic-session-evidence.md) with subject = the commit produced by the session
...
| [Agentic session evidence](./agentic-session-evidence.md) | Provenance statement uploaded on SDLC entity such as commit, artifact or release |
