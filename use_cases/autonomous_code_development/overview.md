# Autonomous code development - Overview

## Scenario

An agent picks a development task that someone tagged him on
...
Notice: the autonomous code development use case resembles the Human-in-the-loop code development and only deffers in human review which is missing from the autonomous development.

## Mental Model

### Accountability

The user who's identity is used by the agent. The owner of the agent.
